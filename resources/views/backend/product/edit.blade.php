...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}"   enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="inputmodelnumber" class="col-form-label">Model Number<span class="text-danger">*</span></label>
            <input id="inputmodelnumber" type="text" name="model_number" placeholder="Enter Model Number "
            value="{{$product->model_number}}"
        class="form-control">
            @error('inputmodelnumber')
            <span class="text-danger">{{$message}}</span>
            @enderror
          </div>
        ...
        <div class="form-group">
          ...
          <select name="brand_id" class="form-control">
             ...
             @foreach($vendors as $vendor)
              <option value="{{$vendor->id}}" {{(($product->brand_id==$vendor->id)? 'selected':'')}}>{{$vendor->name}}</option>
             @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <div>
                    <img src="{{asset('backend/product/'. $product->photo)}}" alt="{{$product->photo}}" width="260px">
                </div>
          </div>
            @error('photo')
            <span class="text-danger">{{$message}}</span>
